        ...
        <div className="rounded-3xl border border-[#cbcbcb] bg-white overflow-hidden shadow-xl flex flex-col h-[calc(100vh-96px)]">
            <div className="px-4 py-3 border-b border-zinc-100 flex items-center justify-between bg-white z-10 shrink-0">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="text-[15px] font-bold text-[#818181] tracking-tight">Current Order</div>
                    <span className="ml-1 inline-flex items-center justify-center px-2 py-0.5 rounded-full bg-[#818181] text-white text-[11px] font-bold shadow-sm">
                        {cartItems.length}
                    </span>
                </div>
            ...
            <div className="px-4 py-2 border-b border-zinc-100 bg-[#dddddd]/50 shrink-0">
                <div className="relative">
                    ...
                    <select
                        ...
                        className="w-full h-10 pl-10 pr-4 rounded-xl border border-[#cbcbcb] bg-white text-[13px] font-bold text-[#818181] focus:outline-none focus:ring-2 focus:ring-[#818181]/20 focus:border-[#818181] shadow-sm transition-all appearance-none"
                    >
            ...
            <div ref={listRef} data-testid={scrollTestId} className="flex-1 overflow-y-auto px-4 py-3 scrollbar-thin scrollbar-thumb-[#cbcbcb]">
                    ...
                    <div className="mb-4 rounded-2xl border border-[#cbcbcb] bg-[#dddddd] p-4 shadow-sm">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0">
                                <div className="text-[13px] font-bold text-[#818181]">Insufficient Stock</div>
                ...
                {cartItems.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-[#cbcbcb] py-10">
                        ...
                        <div className="text-[14px] font-bold text-[#818181]">Your cart is empty</div>
                                ...
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="min-w-0 flex-1">
                                            <div className="text-[14px] font-bold text-[#818181] truncate">{item.name}</div>
                                            <div className="mt-1 flex flex-wrap items-center gap-2 text-[12px] font-medium text-[#a6a6a6]">
                                                ...
                                                {item.is_custom ? (
                                                    <span className="px-2 py-0.5 rounded-md bg-[#dddddd] text-indigo-700 text-[10px] font-bold uppercase tracking-wider">
                                                        Custom
                                                    </span>
                                                ) : null}
                                    ...
                                    <div className="mt-3 flex items-center justify-between gap-3">
                                        <div className="inline-flex items-center rounded-xl border border-[#cbcbcb] bg-white shadow-sm p-1">
                                            ...
                                            <div className="w-10 text-center text-[13px] font-bold text-[#818181]">{item.quantity}</div>
                                            <button
                                                type="button"
                                        ...
                                        <div className="text-[15px] font-black text-[#818181] tracking-tight">
            ...
            <div className="px-4 py-3 border-t border-[#cbcbcb] bg-white shrink-0 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.02)]">
                <div className="space-y-1 mb-3">
                    ...
                    <div className="flex items-center justify-between gap-4 py-1">
                        <div className="flex items-center gap-2 text-[13px] font-bold text-[#a6a6a6]">
                        ...
                        <div className="relative">
                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#cbcbcb] font-bold text-sm">{PESO}</span>
                            <input
                                type="number"
                                value={discount}
                                onChange={(e) => setDiscount(Math.max(0, parseFloat(e.target.value) || 0))}
                                className="w-28 h-8 pl-7 pr-3 rounded-xl border border-[#cbcbcb] bg-[#dddddd] text-[13px] font-bold text-right text-[#818181] focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#818181]/20 focus:border-[#818181] transition-all"
                            />
                        </div>
                    </div>
                    <div className="flex justify-between items-end pt-2 border-t border-dashed border-[#cbcbcb] mt-2">
                        <span className="text-[13px] font-bold text-[#a6a6a6] uppercase tracking-wider">Total</span>
                        <span className="text-[24px] font-black text-[#818181] tracking-tight leading-none">{PESO}{finalTotal.toLocaleString()}</span>
                    </div>
                </div>
                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`group h-10 rounded-xl text-[12px] font-bold inline-flex items-center justify-center gap-2 transition-all border-2 ${
                                    active
                                        ? isCash
                ...
                <div className="grid grid-cols-[1fr_2fr] gap-2">
                    <button
                        ...
                        className="h-11 rounded-xl border border-[#cbcbcb] bg-white text-[13px] font-bold text-[#818181] hover:bg-[#dddddd] hover:border-red-100 transition-colors disabled:opacity-50 disabled:hover:bg-white disabled:hover:border-[#cbcbcb]"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="h-11 rounded-xl bg-white border-2 border-green-600 text-green-600 text-[13px] font-black hover:bg-green-50 transition-all disabled:opacity-50 disabled:hover:bg-white shadow-sm hover:shadow hover:-translate-y-0.5 active:translate-y-0"
                    >
                        Complete Order
                    </button>
                </div>
...
const POSTerminal = () => {
    ...
    if (loading) return (
        <div className="h-[80vh] flex flex-col items-center justify-center">
            ...
            <div className="mt-4 text-[#a6a6a6] font-bold tracking-wide">Initializing POS...</div>
        </div>
    );
            ...
            {compareMode ? (
                <div className="fixed z-[70] right-4 bottom-4 w-[320px] rounded-2xl border border-[#cbcbcb] bg-white shadow-xl p-4">
                    <div className="flex items-center justify-between mb-3">
                        <div className="text-sm font-bold text-[#818181]">Compare Mode</div>
                        <a
                            href="/cashier/pos"
                            className="text-[12px] font-bold text-[#818181] hover:text-indigo-800"
                        >
                            Exit
                        </a>
                    </div>
                    <label className="block text-[11px] font-bold text-[#a6a6a6] mb-2 uppercase tracking-wider">Upload screenshot</label>
                    <input
                        type="file"
                        accept="image/*"
                        onChange={(e) => {
                        ...
                        className="block w-full text-[12px] file:mr-3 file:px-4 file:py-2 file:rounded-lg file:border-0 file:bg-[#dddddd] file:text-[#818181] file:font-bold hover:file:bg-zinc-200 transition-colors"
                    />
                    <div className="mt-4">
                        <div className="flex items-center justify-between text-[11px] font-bold text-[#a6a6a6] mb-2 uppercase tracking-wider">
                    ...
                    <div className="flex flex-col gap-3 px-1">
                        <form onSubmit={handleSkuScan} className="relative">
                            ...
                            <div className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none">
                                <div className="px-2 py-1 bg-[#dddddd] rounded-lg text-[10px] font-bold text-[#a6a6a6] tracking-wider">SKU</div>
                            </div>
                        </form>
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 h-12 px-5 rounded-2xl border border-[#cbcbcb] bg-white text-[14px] font-bold hover:bg-[#dddddd] transition-colors shadow-sm"
                            >
                            ...
                            <button
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 h-12 px-5 rounded-2xl bg-[#818181] text-white text-[14px] font-bold hover:bg-[#a6a6a6] transition-all shadow-md"
                            >
                                <ShoppingCart size={16} />
                                View Cart
                                {cartItems.length > 0 && (
                                    <span className="ml-1 inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full bg-white text-[#818181] text-[11px] font-black">
                                        {cartItems.length}
                                    </span>
                                )}
                            </button>
                ...
                <div className="grid grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <aside className="hidden lg:block col-span-3 xl:col-span-2 min-w-0">
                        <div className="sticky top-[80px]">
                            ...
                            <h2 className="text-[12px] font-black text-[#cbcbcb] uppercase tracking-widest mb-4 px-2">Categories</h2>
                    ...
                    <section className="col-span-12 lg:col-span-5 xl:col-span-6 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 px-1">
                            <div className="text-[14px] font-bold text-[#a6a6a6]" aria-label="Products summary">
                                {itemsLoading ? (
                                    `Loading${ELLIPSIS}`
                                ) : (
                                    <>
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="h-10 px-3 rounded-2xl border border-[#cbcbcb] bg-white text-[12px] font-bold text-[#818181] hover:bg-[#dddddd] disabled:opacity-50"
                                >
                                    Prev
                                </button>
                                <div className="hidden md:flex items-center gap-1" aria-label="Page numbers">
                                    {(() => {
                                        ...
                                        return pages.map((p, idx) => {
                                            if (p === ELLIPSIS) {
                                                return (
                                                    <span key={`pos-ellipsis-${idx}`} className="px-2 text-[12px] font-black text-[#cbcbcb]">
                                                        {ELLIPSIS}
                                                    </span>
                                                );
                                            }
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`min-w-10 h-10 px-3 rounded-2xl border text-[12px] font-black transition-colors ${
                                                        active
                        ...
                        {itemsError ? (
                            <div className="mb-4 px-4 py-3 rounded-2xl border border-[#cbcbcb] bg-[#dddddd] text-[#818181] text-sm font-semibold flex items-center justify-between gap-3">
                                ...
                                <button
                                    ...
                                    className="shrink-0 h-9 px-3 rounded-xl border border-[#cbcbcb] bg-white text-xs font-black text-[#818181] hover:bg-[#dddddd]"
                                >
                                    Retry
                                </button>
                            </div>
                        ...
                        {itemsLoading ? (
                            ...
                            <div className="text-center py-20 bg-white rounded-3xl border border-zinc-100 shadow-sm">
                                ...
                                <h3 className="text-lg font-bold text-[#818181]">No products found</h3>
                                            ...
                                            >
                                                <div className="relative mb-4">
                                                    ...
                                                    {Boolean(item.is_service) && (
                                                        <div className="absolute top-2 right-2 px-2 py-1 rounded-lg bg-white/90 backdrop-blur-sm shadow-sm border border-zinc-100 text-[10px] font-black uppercase tracking-widest text-emerald-600">
                                                            Service
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className="flex-1 flex flex-col">
                                                    <div className="text-[11px] font-bold text-[#cbcbcb] uppercase tracking-widest truncate mb-1">
                                                        {item.category?.name || 'Uncategorized'}
                                                    </div>
                                                    <div className="text-[14px] font-bold text-[#818181] leading-tight mb-2 line-clamp-2">
                                                        {item.name}
                                                    </div>
                                                    
                                                    <div className="mt-auto pt-3 flex items-end justify-between gap-2">
                                                        <div>
                                                            <div className="text-[18px] font-black text-[#818181] tracking-tight">
                                                                {PESO}{Number(item.price).toLocaleString()}
                                                            </div>
                                                            {!item.is_service && (
                                                                <div className={`text-[11px] font-bold mt-0.5 ${out ? 'text-red-500' : low ? 'text-red-600' : 'text-[#a6a6a6]'}`}>
                                ...
                                <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-3xl bg-white p-8 shadow-2xl transition-all border border-zinc-100 text-center">
                                    <div className="flex justify-between items-center mb-6">
                                        <div className="text-left">
                                            <Dialog.Title as="h3" className="text-2xl font-black text-[#818181] tracking-tight">GCash Payment</Dialog.Title>
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-[#dddddd] border border-zinc-100 p-4 rounded-2xl shadow-sm">
                                            <p className="text-[11px] font-black text-[#cbcbcb] uppercase tracking-widest mb-1">Total Amount</p>
                                            <p className="text-3xl font-black text-[#818181] tracking-tight">{PESO}{finalTotal.toLocaleString()}</p>
                                        </div>
                                        <button 
                                            onClick={() => {
                                            ...
                                            className="w-full py-4 bg-[#007DFE] text-white rounded-2xl font-black text-[13px] uppercase tracking-wider hover:bg-[#0069cc] transition-all shadow-lg shadow-[#007DFE20] hover:-translate-y-0.5"
                                        >
                                            Payment Received
                                        </button>
                                    </div>
                            ...
                            <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                                <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-3xl bg-white p-8 shadow-2xl transition-all border border-zinc-100">
                                    <div className="text-center mb-6">
                                        ...
                                        <h2 className="text-[18px] font-black text-[#818181] tracking-tight">{branding.name}</h2>
                                        <p className="text-[12px] text-[#a6a6a6] font-bold uppercase tracking-wider">Boutique Shop POS</p>
                                        <p className="text-[10px] text-[#cbcbcb] font-bold uppercase tracking-wider mt-2">
                                            Cashier: {lastSale?.staff?.name ? `${lastSale.staff.name} (${lastSale.staff.email})` : lastSale?.staff?.email || 'Unknown'}
                                        </p>
                                        <div className="flex justify-between items-center mt-6 text-[10px] font-bold text-[#cbcbcb] uppercase tracking-widest border-b border-[#cbcbcb] pb-3">
                                    ...
                                    <div className="space-y-3 border-b border-dashed border-[#cbcbcb] py-4 mb-4">
                                        {lastSale?.sale_items?.map((item) => {
                                            ...
                                            return (
                                                <div key={item.id}>
                                                    <div className="flex justify-between text-[13px] font-bold text-[#818181]">
                                                        <span className="flex-1 truncate pr-2">
                                                            <span className="font-black text-[#a6a6a6] mr-1">{item.quantity}x</span> {item.item?.name}
                                                        </span>
                                                        <span className="font-black">{PESO}{formatAmount(item.subtotal)}</span>
                                                    </div>
                                                    {mod ? (
                                        ...
                                        {lastSale?.custom_items?.map((item) => {
                                            ...
                                            return (
                                                <div key={`c_${item.id}`}>
                                                    <div className="flex justify-between text-[13px] font-bold text-[#818181]">
                                                        <span className="flex-1 truncate pr-2">
                                                            <span className="font-black text-[#818181] mr-1">{item.quantity}x</span> {item.name}
                                                        </span>
                                                        <span className="font-black">{PESO}{formatAmount(item.subtotal)}</span>
                                                    </div>
                                                    {mod ? (
                                                        <div className="mt-1 text-[10px] font-bold text-[#818181] uppercase tracking-wider">
                                        ...
                                        {lastSale?.modifications?.length ? (
                                            <div className="pt-3 border-t border-zinc-100 mt-2">
                                                <div className="text-[10px] font-black text-[#cbcbcb] uppercase tracking-widest mb-2">
                                                    Audit Log
                                                </div>
                                                <div className="space-y-2">
                                                    {lastSale.modifications.map((m) => (
                                                        <div key={m.id} className="rounded-xl border border-zinc-100 bg-[#dddddd] px-3 py-2">
                                                            <div className="text-[10px] font-black text-[#818181] uppercase tracking-wider flex justify-between gap-3">
                                                                <span className="min-w-0 truncate">{m.type}: {m.label}</span>
                                                                <span className="text-[#cbcbcb] font-mono">{m.approval_id}</span>
                                                            </div>
                                                            <div className="mt-1 text-[9px] font-bold text-[#a6a6a6] uppercase tracking-wider">
                                    ...
                                    <div className="space-y-2 text-right mb-8">
                                        <div className="flex justify-between text-[11px] text-[#a6a6a6] font-bold uppercase tracking-widest">
                                            <span>Subtotal</span>
                                        ...
                                        <div className="flex justify-between text-2xl font-black text-[#818181] pt-4 border-t border-[#cbcbcb] mt-2 tracking-tight">
                                            <span>Total Paid</span>
                                            <span>{PESO}{formatAmount(receiptTotal)}</span>
                                        </div>
                                        <p className="text-[10px] text-[#a6a6a6] font-bold uppercase tracking-widest mt-4 bg-[#dddddd] py-2 rounded-xl text-center">Paid via {lastSale?.payment_method || paymentMethod}</p>
                                    </div>

                                    <div className="text-center space-y-4">
                                        <p className="text-[11px] font-black text-[#cbcbcb] uppercase tracking-widest">Thank you for your visit!</p>
                                        <div className="flex gap-3">
                                            <button 
                                                onClick={() => window.print()}
                                                className="flex-1 py-4 border-2 border-[#cbcbcb] text-[#a6a6a6] rounded-2xl font-black text-[12px] uppercase tracking-wider hover:bg-[#dddddd] hover:border-[#a6a6a6] transition-all shadow-sm"
                                            >
                                                Print
                                            </button>
                                            <button 
                                                onClick={() => setIsReceiptModalOpen(false)}
                                                className="flex-1 py-4 bg-[#818181] text-white rounded-2xl font-black text-[12px] uppercase tracking-wider hover:bg-[#a6a6a6] transition-all shadow-lg hover:-translate-y-0.5"
                                            >
                                                Done
                                            </button>
                                        </div>
